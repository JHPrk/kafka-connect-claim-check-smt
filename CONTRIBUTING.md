...
## Forking the Project
To contribute, you will first need to fork the [kafka-connect-claim-check-smt](https://github.com/cokelee777/kafka-connect-claim-check-smt) repository.

This can be done by looking in the top-right corner of the repository page and clicking "Fork".

The next step is to clone your newly forked repository onto your local workspace. This can be done by going to your newly forked repository, which should be at `https://github.com/USERNAME/kafka-connect-claim-check-smt`.
...
1. First `cd` to the directory where you cloned the project (eg: `cd kafka-connect-claim-check-smt`)
...
2. Please link the issue you worked on in the description of your pull request and in your commit message. For example, for issue-94, the PR description and commit message could be: ```refactor: Refactor ClaimCheckStorage to comply with Interface Segregation Principle (ISP) #94```

3. Your PR should include tests for the functionality that you are adding.

4. Your PR should include appropriate [documentation](https://github.com/cokelee777/kafka-connect-claim-check-smt/blob/main/README.md) for the functionality that you are adding.
